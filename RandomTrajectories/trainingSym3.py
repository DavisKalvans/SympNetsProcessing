...
convParams = (x0, 10, 1, 14, dim, False) # x0, Tend, lower power, upper power, dim, best
...
convParamsMult = (10, 1, 14, dim, area, 0, 10, False) # Tend, lower power, upper power, area for starting points,
...
for nL in [4]:
    for nN in [8]:
        ...
        predParamsMult = (1000, tau, area, 0, 10, True)
        convParamsMult = (10, 1, 14, dim, area, 0, 10, False) # Tend, lower power, upper power, area for starting points,
