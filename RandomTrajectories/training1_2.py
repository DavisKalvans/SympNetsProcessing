...
predParams = (1000, tau, x0_Pendulum, False) # Time steps, x0, best
convParams = (x0_Pendulum, 10, 0, 5, dim, False) # x0, Tend, lower power, upper power, dim, best
predParamsMult = (1000, tau, area_Pendulum, 0, 100, False) # Time steps, area for starting points, timestep to use, seed, 
#nr of trajectories, use the best model or not
convParamsMult = (100, 0, 5, dim, area_Pendulum, 0, 100, False) # Tend, lower power, upper power, area for starting points,
