...
convParams = (x0_Pendulum, 10, 1, 4, dim, False) # x0, Tend, lower power, upper power, dim, best
...
for nL in [2, 4, 8]:
    for nN in [16]:
        ...
        convParams_best = (x0_Pendulum, 10, 1, 4, dim, True) # x0, Tend, lower power, upper power, dim, best
