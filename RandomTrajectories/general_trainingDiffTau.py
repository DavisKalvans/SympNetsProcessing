...
def train_model(problem, method, device, data, trainParams, nL, nN, nM, extraParams = None):
    ...
    if sch:
        model_name = f'TrainedModels/{method}/diffTau/{problem}/sch{problem}RandN{N}M{M}minTau{min_txt}maxTau{max_txt}_{epochs_th}TH_{eta1_txt}eta1_{eta2_txt}eta2_' +f
    else:
        model_name = f'TrainedModels/{method}/diffTau/{problem}/{problem}RandN{N}M{M}minTau{min_txt}maxTau{max_txt}_{epochs_th}TH_{eta1_txt}eta1_' +f
...
def model_predictions(problem, method, device, data, trainParams, nL, nN, nM, predParams, extraParams = None):
    ...
    if sch:
        model_name = f"TrainedModels/{method}/diffTau/{problem}/sch{problem}RandN{N_train}M{M_test}minTau{min_txt}maxTau{max_txt}_{epochs_th}TH_{eta1_txt}eta1_{eta2_txt}eta2_{nL}L{nN}n{nM}m"
    else:
        model_name = f"TrainedModels/{method}/diffTau/{problem}/{problem}RandN{N_train}M{M_test}minTau{min_txt}maxTau{max_txt}_{epochs_th}TH_{eta1_txt}eta1_{nL}L{nN}n{nM}m"
    ...
    file_name = model_name.replace(f"TrainedModels/{method}/diffTau/{problem}/", f"TrainedModels/{method}/diffTau/{problem}/Predictions/")
...
def model_errors(problem, method, data, trainParams, nL, nN, nM, plotParams, extraParams = None):
    ...
    if sch:
        model_name = f"TrainedModels/{method}/diffTau/{problem}/Predictions/sch{problem}RandN{N_train}M{M_test}minTau{min_txt}maxTau{max_txt}_{epochs_th}TH_{eta1_txt}eta1_{eta2_txt}eta2_{nL}L{nN}n{nM}m_T1000Alternate.npy"
    else:
        model_name = f"TrainedModels/{method}/diffTau/{problem}/Predictions/{problem}RandN{N_train}M{M_test}minTau{min_txt}maxTau{max_txt}_{epochs_th}TH_{eta1_txt}eta1_{nL}L{nN}n{nM}m_T1000Alternate.npy"
...
def model_multTrajectErrors(problem, method, device, data, trainParams, nL, nN, nM, predParamsMult, extraParams = None):
    ...
    if linear:
        plot_name = model_name.replace(f'diffTau/{problem}/', f'diffTau/{problem}/PredictionsMultiple/Linear/')
    else:
        plot_name = model_name.replace(f'diffTau/{problem}/', f'diffTau/{problem}/PredictionsMultiple/Sigmoid/')
...
def model_conv(problem, method, device,  data, trainParams, nL, nN, nM, convParams, extraParams = None):
    ...
    # Save plots
    if linear:
        plot_name = model_name.replace(f'TrainedModels/{method}/diffTau/{problem}/', f'TrainedModels/{method}/diffTau/{problem}/ConvergenceGraphs/Linear/')
    else:
        plot_name = model_name.replace(f'TrainedModels/{method}/diffTau/{problem}/', f'TrainedModels/{method}/diffTau/{problem}/ConvergenceGraphs/Sigmoid/')
...
def model_multTrajectConv(problem, method, device,  data, trainParams, nL, nN, nM, convParamsMult, extraParams = None):
    ...
    # Save plots
    if linear:
        plot_name = model_name.replace(f'TrainedModels/{method}/diffTau/{problem}/', f'TrainedModels/{method}/diffTau/{problem}/ConvergenceGraphsMultiple/Linear/')
    else:
        plot_name = model_name.replace(f'TrainedModels/{method}/diffTau/{problem}/', f'TrainedModels/{method}/diffTau/{problem}/ConvergenceGraphsMultiple/Sigmoid/')
