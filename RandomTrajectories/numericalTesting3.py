...
'''
See if postion/energy matches for solve_ivp and the 8-th order Verlet.
Obiously not, because we need to get our higher Verlte to use smaller step size
internally, 0.01 should achieve the neccesarry precision that we can get.
'''
...
ax.plot(pred_numeric[:, 0], pred_numeric[:, 1], color = 'g', label = "eight order Verlet")
...
ax.plot(tm, energies_pred, color = 'g', label = 'eight order Verlet')
