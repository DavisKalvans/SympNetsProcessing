    ...
    for nN in [4, 8, 16, 32]:
        ...
        for nM in [0]:    
            ...
            for nnet in [0]:
                ...
                if sch:
                    file_w = f'TrainedModels/Pendulum/schPendulumLinearRandN{N}M{M}Const{tau_txt}Tau{epochs_th}TH_{eta1_txt}eta1_{eta2_txt}eta2_' +f
                else:
                    file_w = f'TrainedModels/Pendulum/PendulumLinearRandN{N}M{M}Const{tau_txt}Tau{epochs_th}TH_{eta1_txt}eta1_' +f
