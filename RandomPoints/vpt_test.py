...
print(f'Euler VPT with timestep {tau} is {VPT_euler}')
...
ax.plot(ground_truth.y.T[-10:, 0], ground_truth.y.T[-10:, 1], color = 'k', linewidth = '2')
ax.plot(pred[-10::, 0], pred[-10::, 1], color = 'g')
ax.plot(pred_Euler[-10::, 0], pred_Euler[-10::, 1], color = 'r', linestyle = '--')
