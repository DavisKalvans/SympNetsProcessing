...
class Lennard_Jones():
    ...
    def problem(t, y): # Problem for odesolvers 
        q1, q2, q3, q4, p1, p2, p3, p4 = y
        f = np.zeros(8)
        ...
        d1 = q1 -q2
        d2 = q4 -q1
        f[4] = 4*119.8*(-12*(0.341/d1)**12/d1 +6*(0.341/d2)**6/d1 +12*(0.341/d2)**12/d2 -6*(0.341/d2)**6/d2)
        d1 = q2 -q3
        d2 = q1 -q2
        f[5] = 4*119.8*(-12*(0.341/d1)**12/d1 +6*(0.341/d2)**6/d1 +12*(0.341/d2)**12/d2 -6*(0.341/d2)**6/d2)
        d1 = q3 -q4
        d2 = q2 -q3
        f[6] = 4*119.8*(-12*(0.341/d1)**12/d1 +6*(0.341/d2)**6/d1 +12*(0.341/d2)**12/d2 -6*(0.341/d2)**6/d2)
        d1 = q4 -q1
        d2 = q3 -q4
        f[7] = 4*119.8*(-12*(0.341/d1)**12/d1 +6*(0.341/d2)**6/d1 +12*(0.341/d2)**12/d2 -6*(0.341/d2)**6/d2)
