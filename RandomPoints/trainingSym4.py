...
convParamsMult = (10, 1, 14, dim, area_Pendulum, 0, 10, False) # Tend, lower power, upper power, area for starting points,
...
for nL in [2]:
    for nN in [16]:
        ...
        #general_trainingVerlSym.model_predictions(problem, method, device, data, trainParams, nL, nN, nM, predParams, extraParams)
        #general_trainingVerlSym.model_errors(problem, method, data, trainParams, nL, nN, nM, plotParams, extraParams)
        ...
        predParamsMult = (1000, tau, area_Pendulum, 0, 10, True)
        convParamsMult = (10, 1, 14, dim, area_Pendulum, 0, 10, False) # Tend, lower power, upper power, area for starting points,
