...
predParams = (10000, tau, x0, False) # Time steps, x0, best
...
convParamsMult = (10, 0, 5, dim, area, 0, 100, False) # Tend, lower power, upper power, area for starting points,
...
for nL in [3]:
    for nN in [4]:
        for nM in [0]:
            ...
            print('Now best model')
            #predParams_best = (1000, x0, True) # Time steps, x0, best
            #convParams_best = (x0, 10, 0, 5, dim, True) # x0, Tend, lower power, upper power, dim, best
            predParamsMult_best = (1000, tau, area, 0, 100, True)
            convParamsMult_best = (10, 0, 5, dim, area, 0, 100, True)
