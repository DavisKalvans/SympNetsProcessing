    ...
    for nN in [2]:
        ...
        for nM in [0]:    
            ...
            for nnet in [0]:
                ...
                if sch:
                    file_w = f'TrainedModels/Kepler/schKeplerRandN{N}M{M}Const{tau_txt}Tau{epochs_th}TH_{eta1_txt}eta1_{eta2_txt}eta2_' +f
                else:
                    file_w = f'TrainedModels/Kepler/KeplerRandN{N}M{M}Const{tau_txt}Tau{epochs_th}TH_{eta1_txt}eta1_' +f
